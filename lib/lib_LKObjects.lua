...
function PRIVATE.GetType(id)
	if type(id) == "string" and string.lower(id) == "anchor" then
		return TYPE_ANCHOR
	elseif type(id) == "string" and string.lower(id) == "rendertarget" then
		return TYPE_RENDERTARGET
	elseif type(id) == "string" and string.lower(id) == "trackingframe" then
